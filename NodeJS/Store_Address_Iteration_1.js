...
var storedAddress = JSON.parse(event.result).address;
con.connect(function(err) {
  if (err) throw err;
  var sql = 'UPDATE intake SET address= "' + storedAddress + '" WHERE phone = "' + (event.from.trim().substring(1)) + '"';
  console.log(sql)
...
var responseJSON = {
        ...
        "nextModule": 1368913 // OPTIONAL: the ID of a module to follow this Node JS module
    }
