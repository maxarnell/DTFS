...
con.connect(function(err) {
  if (err) throw err;
  var sql = 'UPDATE intake SET email= "' + event.reply + '" WHERE phone = "' + (event.from.trim().substring(1)) + '"';
  console.log(sql)
...
var responseJSON = {
        ...
        "nextModule": 1368915 // OPTIONAL: the ID of a module to follow this Node JS module
    }
