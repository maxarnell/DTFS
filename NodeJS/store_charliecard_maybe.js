...
con.connect(function(err) {
  if (err) throw err;
  var sql = 'UPDATE intake SET eligibility = "2" WHERE phone = "' + (event.from.trim().substring(1)) + '"';
  console.log(sql)
...
var responseJSON = {
        ...
        "nextModule": 1368917 // OPTIONAL: the ID of a module to follow this Node JS module
    }
