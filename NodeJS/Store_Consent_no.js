...
con.connect(function(err) {
  if (err) throw err;
  var sql = 'UPDATE intake SET consentdone = "n" WHERE phone = "' + (event.from.trim().substring(1)) + '"';
  console.log(sql)
...
var responseJSON = {
        ...
        "nextModule": 1380586 // OPTIONAL: the ID of a module to follow this Node JS module
    }
