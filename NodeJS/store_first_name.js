...
con.connect(function(err) {
  if (err) throw err;
  var sql = 'UPDATE intake SET fname = "' + event.reply + '" WHERE phone = "' + (event.from.trim().substring(1)) + '"';
  console.log(sql)
...
var responseJSON = {
        ...
        "nextModule": 1380346// OPTIONAL: the ID of a module to follow this Node JS module
    }
